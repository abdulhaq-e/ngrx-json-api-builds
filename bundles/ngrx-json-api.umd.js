        ...
        return function (state$) {
            return state$.map(function (state) {
                ...
                if (lodash_index.isEmpty(storeQuery.resultIds)) {
                    var /** @type {?} */ queryResult = __assign$3({}, storeQuery, { data: lodash_index.isUndefined(storeQuery.resultIds) ? undefined : [] });
                    return queryResult;
                }
                else {
    ...
    NgrxJsonApiSelectors.prototype.getOneResult$ = function (queryId, denormalize) {
        return function (state$) {
            return state$.map(function (state) {
                ...
                if (lodash_index.isEmpty(storeQuery.resultIds)) {
                    var /** @type {?} */ queryResult = __assign$3({}, storeQuery, { data: lodash_index.isUndefined(storeQuery.resultIds) ? undefined : null });
                    return queryResult;
                }
                else {
    ...
    function NgrxJsonApiEffects(actions$, jsonApi, store, selectors) {
        ...
        this.createResource$ = this.actions$
            ...
            return _this.jsonApi
                ...
                return rxjs_Observable.Observable.of(new ApiPostFailAction(_this.toErrorPayload(payload.query, error)));
            });
        });
        this.updateResource$ = this.actions$
            ...
            return _this.jsonApi
                ...
                .catch(function (error) {
                return rxjs_Observable.Observable.of(new ApiPatchFailAction(_this.toErrorPayload(payload.query, error)));
            });
        });
        this.readResource$ = this.actions$
            ...
            return _this.jsonApi
                ...
                .catch(function (error) {
                return rxjs_Observable.Observable.of(new ApiGetFailAction(_this.toErrorPayload(query, error)));
            });
        });
        this.queryStore$ = this.actions$
            ...
            return _this.store
                ...
                .catch(function (error) {
                return rxjs_Observable.Observable.of(new LocalQueryFailAction(_this.toErrorPayload(query, error)));
            })
        ...
        this.deleteResource$ = this.actions$
            ...
            return _this.jsonApi
                ...
                .catch(function (error) {
                return rxjs_Observable.Observable.of(new ApiDeleteFailAction(_this.toErrorPayload(payload.query, error)));
            });
        });
            ...
            var _loop_1 = function (pendingChange) {
                if (pendingChange.state === 'CREATED') {
                    ...
                    actions.push(_this.jsonApi
                        ...
                        .catch(function (error) {
                        return rxjs_Observable.Observable.of(new ApiPostFailAction(_this.toErrorPayload(payload_1.query, error)));
                    }));
                }
                    ...
                    actions.push(_this.jsonApi
                        ...
                        .catch(function (error) {
                        return rxjs_Observable.Observable.of(new ApiPatchFailAction(_this.toErrorPayload(payload_2.query, error)));
                    }));
                }
                    ...
                    actions.push(_this.jsonApi
                        ...
                        .catch(function (error) {
                        return rxjs_Observable.Observable.of(new ApiDeleteFailAction(_this.toErrorPayload(payload_3.query, error)));
                    }));
                }
                else {
